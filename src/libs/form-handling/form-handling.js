...
class FormHandler {
  ...
  init(formId) {
    ...
    let butnAction = form.querySelector('button-action:has(button[type="submit"])');
    let butn = butnAction.querySelector('button');
    console.log('butnnn', butn)
    butn.disabled = true;
  ...
  initRealTimeValidation(form) {
    ...
    const button = form.querySelector('button-action button[type="submit"]');
