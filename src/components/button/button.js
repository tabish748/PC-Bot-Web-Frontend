...
class ButtonAction extends HTMLElement
{
  ...
  _handleAttributes()
  {
    ...
    {
      this.submit_btn.classList.add('theme__btn--danger')
    }
    if(this.hasAttribute('caution'))
    {
      this.submit_btn.classList.add('theme__btn--caution')
    }
  ...
  Render()
  {
    let btnType = this.getAttribute("type") || "submit";
    const html = `
    <button class="theme__btn" id="submit_btn"  type="${btnType}" >
